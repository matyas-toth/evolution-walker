    ...
    >
      <div className="p-4 border-b border-border space-y-4 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-xl -translate-y-px">
            Training Hub
          </h2>
        </div>

        <div className="grid grid-cols-2 gap-4 text-sm ">
          <div className="bg-muted p-2 rounded-lg text-center border">
          ...
          <div className="bg-muted p-2 rounded-lg text-center border">
            ...
            <div className="font-mono text-lg font-bold text-primary">
              {(diagnostics.bestDistance ?? bestFitness).toFixed(0)} px
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 rounded-lg border border-border bg-accent p-4 text-[11px]">
          <div>
          ...
          <div>
            <div className="text-muted-foreground">
              {config.backgroundMode ? "Throughput" : "Paced rate"}
            </div>
            <div className="font-mono font-medium">
              {diagnostics.generationsPerSecond.toFixed(2)} gen/s
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="font-mono font-medium">
              {(diagnostics.memoryBytes / 1048576).toFixed(1)} MB
            </div>
          </div>
            ...
            <>
              <div>
                ...
                <div className="font-mono">
                  {diagnostics.stageTimings.simulationMs.toFixed(1)} ms
                </div>
              </div>
              <div>
                ...
                <div className="font-mono">
                  {(
                    diagnostics.stageTimings.fitnessMs +
                    diagnostics.stageTimings.evolutionMs +
                    diagnostics.stageTimings.resetMs
                  ).toFixed(1)}{" "}
                  ms
                </div>
              </div>
              ...
              <div>
                ...
                <div className="font-mono">
                  {((diagnostics.bestGaitQuality ?? 0) * 100).toFixed(0)}%
                </div>
              </div>
              <div>
                <div className="text-muted-foreground">Archive coverage</div>
                <div className="font-mono">
                  {((diagnostics.archiveCoverage ?? 0) * 100).toFixed(1)}%
                </div>
              </div>
              <div>
                <div className="text-muted-foreground">Genome diversity</div>
                <div className="font-mono">
                  {(diagnostics.genomeDiversity ?? 0).toFixed(3)}
                </div>
              </div>
              <div>
                <div className="text-muted-foreground">Stagnation</div>
                <div className="font-mono">
                  {diagnostics.stagnationGenerations ?? 0} gen
                </div>
              </div>
            </>
          ) : null}
        ...
        <div className="flex gap-2">
          ...
          >
            {pausePending ? (
              <>
                <Square className="w-4 h-4 fill-current" /> Pausing…
              </>
            ) : isRunning ? (
              <>
                <Square className="w-4 h-4 fill-current" /> Pause Evolution
              </>
            ) : isPaused ? (
              <>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(c) =>
                onChangeConfig({ ...config, backgroundMode: c })
              }
            />
          </div>
          <p className="text-xs text-muted-foreground">
            Runs unpaced at maximum compute throughput and disables live
            rendering.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={(event) =>
              onChangeConfig({
                ...config,
                backend: event.target.value as NonNullable<
                  TrainingHubConfig["backend"]
                >,
              })
            }
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={([v]) =>
                onChangeConfig({ ...config, populationSize: v })
              }
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={([v]) =>
                onChangeConfig({ ...config, simulationSpeed: v })
              }
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={([v]) =>
                onChangeConfig({ ...config, generationDuration: v })
              }
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={([v]) =>
                onChangeConfig({ ...config, mutationRate: v })
              }
            />
          </div>
          ...
          <div className="space-y-2">
            <Label>
              Mutation Strength: {config.mutationStrength.toFixed(2)}
            </Label>
            <Slider
              ...
              onValueChange={([v]) =>
                onChangeConfig({ ...config, mutationStrength: v })
              }
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={([v]) =>
                onChangeConfig({ ...config, targetDistance: v })
              }
            />
          </div>
        </div>
