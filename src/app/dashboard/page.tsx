...
} from "@/components/dashboard/TrainingSessionsTable";
...
export default async function DashboardPage() {
  ...
  const serializedSessions: DashboardTrainingSession[] = trainingSessions.map(
    (trainingSession) => {
      const config =
        trainingSession.config as unknown as Partial<TrainingHubConfig>;
